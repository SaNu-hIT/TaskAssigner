...
import com.leeway.athirapb.Activity.Fragment.TicketsFragment.PendingFragment.OnListFragmentInteractionListenerpendeing;
 ...
 * specified {@link OnListFragmentInteractionListenerpendeing}.
...
public class MyPendingRecyclerViewAdapter extends RecyclerView.Adapter<MyPendingRecyclerViewAdapter.ViewHolder> {
    ...
    private final OnListFragmentInteractionListenerpendeing mListener;
    Context context;

    public MyPendingRecyclerViewAdapter(List<TicketInfo> items, OnListFragmentInteractionListenerpendeing listener, Context context) {
        mValues = items;
        mListener = listener;
